...
#锚点框文件
parser.add_argument("--anchor_path", type=str, default="./data/yolo_anchors.txt", #./data/yolo_anchors.txt
                    help="The path of the anchor txt file.")
#类别名路径
parser.add_argument("--class_name_path", type=str, default="./data/my_data/data.names",#./data/coco.names
                    help="The path of the class names.")

# some numbers
#训练批次大小
parser.add_argument("--batch_size", type=int, default=10, #20
...
#总共迭代次数
parser.add_argument("--total_epoches", type=int, default=10000,#10000
...
#学习率固定或采用平滑衰退
parser.add_argument("--lr_type", type=str, default='exponential',#fixed
...
# warm up strategy
#是否使用策略
parser.add_argument("--use_warm_up", type=lambda x: (str(x).lower() == 'true'), default=True,#False
